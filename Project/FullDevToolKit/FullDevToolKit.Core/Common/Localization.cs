...
namespace FullDevToolKit.Common
{
    ...
    public class LocalizationText
    {
        ...
        private static void LoadLocalizationENG(ref List<LocalizationTextItem> items)
        {
            ...
            items.Add(new LocalizationTextItem() { Language = "en-us", Code = "24", Name = "API-Unexpected-Exception", Text = "Unexpected error not identified:: GetExceptionMessages@f2]" });
            ...
            items.Add(new LocalizationTextItem() { Language = "en-us", Code = "49", Name = "User-Instance-Exists", Text = "This Instance is already associated with the user." });
            items.Add(new LocalizationTextItem() { Language = "en-us", Code = "50", Name = "User-Instance-No-Exists", Text = "This Instance does not belong to the user." });
        }
